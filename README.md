...
class SmartDevice{
Содержит SmartThermometer ИЛИ SmartSocket
print(состояние устройства)
}

class Room{
new(массив устройств)
Массив SmartDevice: Vec<_>
report() -> список устройств комнаты
}

class House{
Массив Room: Vec<_>
new(массив комнат)
report() -> список устройств во всех комнатах
}

SmartDevice <|-- SmartThermometer
SmartDevice <|-- SmartSocket
Room <|-- SmartDevice
House <|-- Room
```
